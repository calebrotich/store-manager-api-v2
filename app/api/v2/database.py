...
def create_tables():
    ...
    CREATE TABLE IF NOT EXISTS products (
        ...
        added_by VARCHAR (30) NOT NULL REFERENCES users(user_id) ON DELETE CASCADE,
        category VARCHAR (24) NOT NULL REFERENCES category(category_id) ON DELETE CASCADE
    )"""
    ...
    CREATE TABLE IF NOT EXISTS saleorders (
        ...
        made_by VARCHAR (30) NOT NULL REFERENCES users(user_id) ON DELETE CASCADE
    )"""
